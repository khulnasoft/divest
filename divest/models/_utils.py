...
if major_version >= 8:
    ...
    try:
        ...
        try:
            ...
            logger.warning_once(
                "Divest: Your Flash Attention 2 installation seems to be broken?\n"\
                "A possible explanation is you have a new CUDA version which isn't\n"\
                "yet compatible with FA2? Please file a ticket to Divest or FA2.\n"\
...
__all__ = [
    ...
    "patch_tokenizer",
    "get_statistics",
    "Divest_Offloaded_Gradient_Checkpointer",
    "offload_to_disk",
    "offload_input_embeddings",
    "offload_output_embeddings",
    "is_bfloat16_supported",
    "divest_offloaded_gradient_checkpoint",
]
...
try:
    ...
    logger.warning_once(
        "Divest unsuccessfully patched LoraLayer.update_layer. Please file a bug report.\n"\
    ...
    try:
        ...
        if statistics is not None:
            ...
            if not are_progress_bars_disabled():
                ...
                disabled = True
            pass
            hf_hub_download(f"khulnasoft/statistics-{statistics}", "README.md", force_download = True)
            if disabled:
...
class Divest_Offloaded_Gradient_Checkpointer(torch.autograd.Function):
    """
...
def divest_offloaded_gradient_checkpoint(function, *args, use_reentrant = None, **kwargs):
    return Divest_Offloaded_Gradient_Checkpointer.apply(function, *args)
pass
...
def offload_to_disk(W, model, name, temporary_location : str = "_divest_temporary_saved_buffers"):
...
def offload_input_embeddings(model, temporary_location : str = "_divest_temporary_saved_buffers"):
...
def offload_output_embeddings(model, temporary_location : str = "_divest_temporary_saved_buffers"):
