...
class FastMistralModel(FastLlamaModel):
    ...
    @staticmethod
    def from_pretrained(
        model_name     = "divest/mistral-7b-bnb-4bit",
        max_seq_length = None,
        dtype          = None,
        load_in_4bit   = True,
        token          = None,
        ...
        **kwargs,
        ...
        if rope_scaling is not None:
            logger.warning_once("Divest: Mistral models do not support RoPE scaling.")
        pass
        ...
        if max_seq_length > model_max_seq_length:
            raise RuntimeError(
                f"Divest: Unfortunately {model_patcher.__name__[4:-5]} type models do not support RoPE scaling!\n"\
        ...
        if n_total_devices > 2:
            logger.warning_once(
                "Please consider a commercial license - Divest was designed for the GPU Poor.\\n"
